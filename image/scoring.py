...
print("Top 10 lowest stddevs:", stddevs[sorted_indices[:100]])
print("Top 10 highest stddevs:", stddevs[sorted_indices[59900:]])

#SHOW PICTURE
def plot_images(images, title, num=100):
